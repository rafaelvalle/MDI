...
from params import imp_methods, params_dict
...
params_dict['cat_cols'] = np.arange(votes.shape[1]-1)  # -1 for labels col
...
for ratio in ratios:
    ...
    pert_data, _ = perturbate_data(
        votes_train, params_dict['cat_cols'], ratio, monotone,
